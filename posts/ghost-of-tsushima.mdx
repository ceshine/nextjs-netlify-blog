...
date: 2020-10-13
cover: /images/ghost-of-tsushima-review.jpg
author: ceshine
tags:
  - game
---
<figure>
  ...
  <figcaption><a href="https://www.essentiallysports.com/ghost-of-tsushima-developers-reveal-the-secret-behind-stunning-visuals-playstation-esports-news/">source</a></figcaption>
</figure>

I recently “finished” Ghost of Tsushima [on YouTube](https://www.youtube.com/playlist?list=PLVknSjv5hAFJSWy2rEHngAjwUgy-YfwLc). What a game. [The two Mongol invasions of Japan](https://www.wikiwand.com/en/Mongol_invasions_of_Japan) are significant historic events that are only briefly mentioned in the history textbooks outside Japan AFAIK. This game prompted me to do some research and learn more about them. This alone is already worth the (metaphorical) ticket.
...
The way of ghost adopted by the protagonist sounds a lot like [the way of ninja](https://www.wikiwand.com/en/Ninja). However, ninjas were not widely used by the Japanese until the 15th century, so it's explainable why the protagonist was treated as a pagan to the Japanese culture. 
...
Given the scale of the campaign and the ostensible stake involved, it would make more practical sense if the story happens in [Kyushu](https://www.wikiwand.com/en/Kyushu), but it'll become more historically inaccurate. It would be even more interesting in terms of gameplay if the game was based on the [Japanese invasions of Korea](https://www.wikiwand.com/en/Japanese_invasions_of_Korea_(1592%E2%80%931598)). However, playing as the invading force will be very insensitive to the Korean, and since the Chinese were involved in the war as well, the nationalistic emotions will very likely make the game very controversial. So unfortunately I don't think we'll see it done well in any foreseeable future.